...
namespace lesson19_预处理指令
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region 2.什么是预处理指令
            //预处理器指令，指导编译器再实际编译开始之前对信息进行处理预处理
            //预处理器指令，都是以#开始
            //预处理器指令不是语句，所以他们不以分号;结束
            //目前我们经常用到的折叠代码块，就是预处理器指令
            #endregion
            ...
            //两者都是写在脚本文件最前面的，一般配合if指令使用或配合特性
...
#elif Unity2017 && Unity2019
            Console.WriteLine("版本为Unity2017");
            //#warning 这个版本 不合法（警告warning）
            //#error 这个版本不准执行（报错error）
#else
